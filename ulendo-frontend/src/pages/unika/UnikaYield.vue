<script setup>
  ...
  import unikaAnnualExceedance from '@/data/unika/output/unikaAnnualExceedance.csv'
  import unikaDurationVariability from '@/data/unika/output/unikaDurationVariability.csv'
